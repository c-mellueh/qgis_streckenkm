...
class DockWidget(QDockWidget):
    def __init__(self, parent=None, iface:QgisInterface=None):
        ...
        self.settings_widget_index = self.tab_widget.addTab(self.settings_widget, QIcon(), self.tr("Settings"))
        self.data_widget = DataWidget(0., 0.)
        self.data_widget_index = self.tab_widget.addTab(self.data_widget, QIcon(), self.tr("Data"))
